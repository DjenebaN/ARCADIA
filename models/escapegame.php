...
class EscapeGame {
    ...
    public function ajouterSalle($nom, $theme_id, $description, $duree, $nb_joueurs_min, $nb_joueurs_max, $prix, $image) {
    ...
    public function getHoraireBySalleId($salle_id) {
        $req = $this->bdd->prepare("SELECT * FROM horaires WHERE salle_id = :salle_id");
        $req->bindParam(':salle_id', $salle_id);
        $req->execute();
        return $req->fetchAll();
    }
