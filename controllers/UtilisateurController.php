...
class UtilisateurController 
{
    ...
    public function create()
    {
        ...
        header('Location: http://localhost/projetfin/index.php?page=connectioninscription&success=inscription');
    ...
    public function login()
    {
        ...
        if ($utilisateur){
            ...
            header('Location: http://localhost/projetfin/index.php?page=connectioninscription');
        }
    }
