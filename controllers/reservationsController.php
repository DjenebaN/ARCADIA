...
class reservationsController
{
    ...
    public function create()
    {
        ...
        header('Location: http://localhost/projetfin/index.php?page=gestionReservations&success=ReservationAjouter');
    }
    ...
    public function annuler()
    {
        ...
        header('Location: http://localhost/projetfin/index.php?page=gestionReservations&success=ReservationAnnuler');
    }
